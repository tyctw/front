...
const timeline = [
  { date: "116/06/05 08:00", title: "會考成績公布", body: "正式成績請以國中教育會考相關官方查詢系統為準。" },
  { date: "116/06/18 起，依各區截止時間", title: "個人序位查詢與志願選填", body: "各就學區截止時間不同，例如基北區為6/18中午12:00至6/25中午12:00，中投區為6/18上午8:00至6/23中午12:00。請依所屬就學區公告完成選填。" },
  { date: "116/07/07 11:00", title: "免試入學分發結果查詢", body: "多數就學區於116/7/7上午11:00公告分發結果。請到所屬就學區查榜入口查詢錄取學校，並保存或列印查詢結果。" },
  { date: "116/07/08，依各區指定時段", title: "分發結果複查", body: "複查時間、地點與方式依各就學區簡章辦理；部分區域要求學生或家長親自送件，且逾期不受理。" },
  { date: "116/07/09，依錄取學校公告", title: "錄取生報到", body: "多數就學區安排於116/7/9辦理報到，常見時段為上午9:00至11:00；實際時段、分流方式與文件請看錄取學校公告。" },
  { date: "多數區域為116/07/13前", title: "報到後放棄錄取資格期限", body: "已報到但要參加其他招生管道者，通常須在規定期限內向錄取學校聲明放棄；常見期限為116/7/13下午2:00前，仍應以各區簡章為準。" },
];
