...
const timeline = [
  { date: "116/06/04", title: "會考成績公布", body: "寄發成績通知單並開放網路查詢；實際開放時刻依官方公告。" },
  { date: "116/06/18–06/24", title: "個人序位查詢與志願選填", body: "6/18 開放個人序位查詢與志願選填，6/24 為截止日，實際辦理時刻依各就學區簡章。" },
  { date: "116/06/29", title: "免試入學與特色招生考試分發入學報名截止", body: "志願選填與報名為不同作業，請確認已依所屬就學區規定完成報名。" },
  { date: "116/07/06", title: "免試入學分發結果查詢", body: "各就學區免試入學及特色招生考試分發入學放榜。請依各區公告的時刻查詢錄取學校，並保存查詢結果。" },
  { date: "依各就學區簡章", title: "分發結果複查", body: "原表未列統一複查日期，申請日期、時段、地點與方式請查閱各就學區簡章。" },
  { date: "116/07/08", title: "錄取生報到", body: "免試入學及特色招生考試分發入學報到。實際時段、方式與文件請看錄取學校公告。" },
  { date: "116/07/12", title: "報到後聲明放棄錄取資格", body: "已報到但要參加其他管道者，請依簡章辦理聲明放棄錄取資格，實際截止時刻以各區簡章為準。" },
  { date: "116/07/27", title: "免試入學續招簡章公告截止", body: "各就學區高級中等學校免試入學續招學校簡章公告截止日；續招報名等日程請依各校簡章。" },
];
        ...
        <div className="grid gap-8 lg:grid-cols-[0.98fr_1.02fr] lg:items-center">
          <div>
            ...
            <p className="mt-5 text-base font-semibold leading-8 text-slate-600">
              本頁整理 116 學年度國中教育會考後，免試入學查榜、報到、複查與放棄錄取資格的常見流程。
              日期以民國 116 年標示，對應西元 2027 年；各就學區時段可能不同，實際作業仍以各就學區委員會、錄取學校與官方簡章公告為準。
            </p>
          </div>
